...
def module_to_KO(strain):
    ...
    OUT_path =  mydir + 'data/metab_paths/MAPLE_clean/' + strain + '_MAPLE_clean/'
...
def clean_kaas(strain):
    IN_kaas_path = mydir + 'data/metab_paths/KAAS/' + strain + '_KAAS_result_ko'
    ...
    OUT_path = mydir + 'data/metab_paths/KAAS_clean/' + strain + '_KAAS_clean.txt'
    OUT = open(OUT_path, 'w')
...
def merge_maple(strain):
    IN_maple_sign_path = mydir + 'data/metab_paths/MAPLE/' + strain + '_MAPLE_result/' + 'module_signature.tsv'
    IN_maple_sign = pd.read_csv(IN_maple_sign_path, sep = '\t')
    IN_maple_cmplx_path = mydir + 'data/metab_paths/MAPLE/' + strain + '_MAPLE_result/' + 'module_complex.tsv'
    IN_maple_cmplx = pd.read_csv(IN_maple_cmplx_path, sep = '\t')
    IN_maple_pthwy_path = mydir + 'data/metab_paths/MAPLE/' + strain + '_MAPLE_result/' + 'module_pathway.tsv'
    IN_maple_pthwy = pd.read_csv(IN_maple_pthwy_path, sep = '\t')
    IN_maple_fxn_path = mydir + 'data/metab_paths/MAPLE/' + strain + '_MAPLE_result/' + 'module_function.tsv'
    ...
    # median = median MCR
    OUT_path = mydir + 'data/metab_paths/MAPLE_clean/' + strain + '_MAPLE_clean/maple_modules.txt'
    df_merged_no_dup.to_csv(OUT_path, sep = '\t', index = False)


def merge_maple_all_strains():
    dfs = []
    maple_path = mydir + 'data/metab_paths/MAPLE_clean/'
    ...
    OUT_path = mydir + 'data/metab_paths/module_by_taxon.txt'
