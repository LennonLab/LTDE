...
#=INPUT-READS	9071350
#=MAPPED-BASES	581159510
#=MAPPED-READS	8677726
INS	1	4	NZ_VCBS01000001	601081	A	frequency=1	insert_position=1	repeat_length=1	repeat_new_copies=8	repeat_ref_copies=7	repeat_seq=A
SNP	2	5	NZ_VCBS01000001	2560833	T	frequency=7.54218102e-02
SNP	3	6	NZ_VCBS01000002	393492	A	frequency=1.36022091e-01
RA	4	.	NZ_VCBS01000001	601074	1	.	A	bias_e_value=4290650	bias_p_value=1	consensus_score=182.6	fisher_strand_p_value=1	frequency=1	ks_quality_p_value=1	major_base=A	major_cov=34/20	major_frequency=9.64358330e-01	minor_base=.	minor_cov=1/1	new_cov=34/20	polymorphism_frequency=9.64358330e-01	polymorphism_reject=SCORE_CUTOFF,FREQUENCY_CUTOFF,VARIANT_STRAND_COVERAGE,INDEL_HOMOPOLYMER	polymorphism_score=-1.0	prediction=consensus	ref_cov=1/1	total_cov=35/21
RA	5	.	NZ_VCBS01000001	2560833	0	G	T	bias_e_value=10625.6	bias_p_value=0.00247644	consensus_score=633.1	fisher_strand_p_value=0.000268519	frequency=7.54218102e-02	ks_quality_p_value=1	major_base=G	major_cov=83/108	major_frequency=9.24578190e-01	minor_base=T	minor_cov=16/2	new_cov=16/2	polymorphism_frequency=7.54218102e-02	polymorphism_score=7.2	prediction=polymorphism	ref_cov=83/108	total_cov=99/110
RA	6	.	NZ_VCBS01000002	393492	0	G	A	bias_e_value=2221820	bias_p_value=0.517828	consensus_score=159.7	fisher_strand_p_value=0.197488	frequency=1.36022091e-01	ks_quality_p_value=1	major_base=G	major_cov=44/28	major_frequency=8.63977909e-01	minor_base=A	minor_cov=10/2	new_cov=10/2	polymorphism_frequency=1.36022091e-01	polymorphism_score=10.9	prediction=polymorphism	ref_cov=44/28	total_cov=57/39
MC	7	.	NZ_VCBS01000004	1	47	46	0	left_inside_cov=0	left_outside_cov=NA	right_inside_cov=47	right_outside_cov=49
