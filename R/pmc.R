...
df.summary.no812 <- cbind(parameter=c("beta.log10","alpha"), 
                    test=c("BM_PL","BM_PL"), 
                    llr=c(BM.PL.beta.log10.no812$lr, BM.PL.alpha.no812$lr),
                    p_value=c(p_value.BM.PL.beta.log10.no812, p_value.BM.PL.alpha.no812),
                    sigsq_BM=c(BM.PL.beta.log10.no812$A$opt$sigsq, BM.PL.alpha.no812$A$opt$sigsq),
                    sigsq_PL=c(BM.PL.beta.log10.no812$B$opt$sigsq, BM.PL.alpha.no812$B$opt$sigsq),
                    lambda=c(BM.PL.beta.log10.no812$B$opt$lambda, BM.PL.alpha.no812$B$opt$lambda)
)
