...
read.aln <- read.alignment(file = "data/align/persistence_prochlorococcus_genomes.good.filter.fasta", format = "fasta") 
...
ml.tree <- read.raxml("data/tree/RAxML_bipartitionsBranchLabels.OutProGen")
