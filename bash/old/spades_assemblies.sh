...
spades.py --careful --cov-cutoff auto \
      ...
      --pe1-1 "${ltde}/illumina_data/ATCC13985_D400_100/Ev13483_TAAGGCGAATCT-AAGGAGTA_L002_R1_001_clean.fastq" \
      --pe1-2 "${ltde}/illumina_data/ATCC13985_D400_100/Ev13483_TAAGGCGAATCT-AAGGAGTA_L002_R2_001_clean.fastq" \
...
spades.py --careful --cov-cutoff auto \
      ...
      --pe1-2 "${ltde}/illumina_data/KBS0703_GSF911/GSF911-Ar_S10_L001_R2_001_clean.fastq" \
...
spades.py --careful --cov-cutoff auto \
      ...
      --pe1-1 "${ltde}/illumina_data/KBS0712_D400_100/Ev712_TAAGGCGAATCT-TATCCTCT_L002_R1_001_clean.fastq" \
      --pe1-2 "${ltde}/illumina_data/KBS0712_D400_100/Ev712_TAAGGCGAATCT-TATCCTCT_L002_R2_001_clean.fastq" \
...
#    prokka --compliant --centre IUB --locustag FCE86 \
